# Baemin Euljiro 10 Years Later (`BM Euljiro 10 years later`) Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

Baemin Euljiro 10 Years Later is a Korean (ID: `KO`) language handwritten font
designed by [Woowa Brothers Corporation](http://www.woowahan.com). It is the
*Baemin Euljiro (`BM EULJIRO`)* font would look like after ten years. Its
weathered look suggests the passing of time and exposure to the elements.

This font is ideal for displaying Korean characters with 10-years elements
exposure.
...
```
Title: Baemin Euljiro 10 Years Later (BM Euljiro 10 years later) Font
Creators: Woowa Brothers Corporation
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-bm-euljiro-10-years-later
UUID: 915F585D-BBC7-49DC-A6C2-6704D785106F
...
Procure: https://github.com/ChewKeanHo/visuals-fonts-bm-euljiro-10-years-later
```
